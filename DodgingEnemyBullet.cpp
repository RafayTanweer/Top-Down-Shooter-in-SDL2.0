...
//Constructor
DodgingEnemyBullet::DodgingEnemyBullet() {


}

//Constructor
DodgingEnemyBullet::DodgingEnemyBullet(int x, int y, SDL_Renderer* gRenderer) {
...
SDL_Rect* DodgingEnemyBullet::GetClip() {
...
void DodgingEnemyBullet::Render(SDL_Renderer* gRenderer) {
